...
COLUNAS = ["titulo_original", "titulo_pt", "autor", "ano", "link", "tipo",
           "status_link", "explicacao", "fonte", "avaliacao_humana"]
...
LARGURAS = {
    ...
    "tipo": 14, "status_link": 20, "explicacao": 60, "fonte": 25, "avaliacao_humana": 16,
}
...
def _linha_de_item(item):
    return [
        ...
        item.tipo, item.status_link, item.explicacao, item.fonte, item.avaliacao_humana,
    ]
