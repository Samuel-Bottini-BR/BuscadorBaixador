...
"""
import sys, glob, os, concurrent.futures as cf
...
try:
    from buscador.core.verificacao_links import COR, analisar, host_de
except ImportError:
    print("Pacote 'buscador' não instalado. Rode:  pip install -e .[dev]"); sys.exit(1)
